...
class V1Beta1DisableConsumerResponse(BaseModel):
    pass


class V1Beta1EnableConsumerResponse(BaseModel):
    pass
...
class V1Beta1ProducerQuotaPolicy(BaseModel):
...
class V1Beta1RefreshConsumerResponse(BaseModel):
    pass
...
class V1Beta1ServiceIdentity(BaseModel):
    ...
    uniqueId: Optional[str] = Field(
        None, description='The unique and stable id of the service identity.'
    )


class V1beta1AddVisibilityLabelsResponse(BaseModel):
...
class V1beta1DefaultIdentity(BaseModel):
    email: Optional[str] = Field(
        None, description='The email address of the default identity.'
    )
    name: Optional[str] = Field(
        None,
        description='Default identity resource name. An example name would be: `services/serviceconsumermanagement.googleapis.com/projects/123/defaultIdentity`',
    )
    tag: Optional[str] = Field(
        None,
        description='The Default Identity tag. If specified when creating the account, the tag must be present in activation_grants. If not specified when creating the account, the tag is set to the tag specified in activation_grants.',
    )
    uniqueId: Optional[str] = Field(
        None, description='The unique and stable id of the default identity.'
    )
...
class V1beta1GenerateDefaultIdentityResponse(BaseModel):
    attachStatus: Optional[AttachStatus] = Field(
        None,
        description='Status of the role attachment. Under development (go/si-attach-role), currently always return ATTACH_STATUS_UNSPECIFIED)',
    )
    identity: Optional[V1beta1DefaultIdentity] = Field(
        None, description='DefaultIdentity that was created or retrieved.'
    )
    role: Optional[str] = Field(
        None,
        description='Role attached to consumer project. Empty if not attached in this request. (Under development, currently always return empty.)',
    )
...
class V1beta1RemoveVisibilityLabelsResponse(BaseModel):
    labels: Optional[List[str]] = Field(
        None,
        description='The updated set of visibility labels for this consumer on this service.',
    )
...
class V1beta1ServiceAccount(BaseModel):
    ...
    iamAccountName: Optional[str] = Field(
        None, description='Deprecated. See b/136209818.'
    )
    name: Optional[str] = Field(
        None,
        description='P4 SA resource name. An example name would be: `services/serviceconsumermanagement.googleapis.com/projects/123/serviceAccounts/default`',
    )
    tag: Optional[str] = Field(
        None,
        description='The P4 SA configuration tag. This must be defined in activation_grants. If not specified when creating the account, the tag is set to "default".',
    )
    uniqueId: Optional[str] = Field(
        None, description='The unique and stable id of the service account.'
    )
...
class V1Beta1BatchCreateProducerOverridesResponse(BaseModel):
    overrides: Optional[List[V1Beta1QuotaOverride]] = Field(
        None, description='The overrides that were created.'
    )


class V1Beta1GenerateServiceIdentityResponse(BaseModel):
    identity: Optional[V1Beta1ServiceIdentity] = Field(
...
class V1Beta1ImportProducerQuotaPoliciesResponse(BaseModel):
    policies: Optional[List[V1Beta1ProducerQuotaPolicy]] = Field(
        None, description='The policies that were created from the imported data.'
    )


class V1Beta1ListProducerOverridesResponse(BaseModel):
    nextPageToken: Optional[str] = Field(
        None,
        description='Token identifying which result to start with; returned by a previous list call.',
    )
    overrides: Optional[List[V1Beta1QuotaOverride]] = Field(
        None, description='Producer overrides on this limit.'
    )


class V1Beta1OverrideInlineSource(BaseModel):
    overrides: Optional[List[V1Beta1QuotaOverride]] = Field(
        None,
...
class V1Beta1QuotaBucket(BaseModel):
    adminOverride: Optional[V1Beta1QuotaOverride] = Field(
        None, description='Admin override on this quota bucket.'
    )
    consumerOverride: Optional[V1Beta1QuotaOverride] = Field(
    ...
    producerOverride: Optional[V1Beta1QuotaOverride] = Field(
        None, description='Producer override on this quota bucket.'
    )


class V1beta1GenerateServiceAccountResponse(BaseModel):
    account: Optional[V1beta1ServiceAccount] = Field(
        None, description='ServiceAccount that was created or retrieved.'
    )
...
class V1Beta1ConsumerQuotaLimit(BaseModel):
    ...
    quotaBuckets: Optional[List[V1Beta1QuotaBucket]] = Field(
        None,
...
class V1Beta1ConsumerQuotaMetric(BaseModel):
    consumerQuotaLimits: Optional[List[V1Beta1ConsumerQuotaLimit]] = Field(
        None,
        description='The consumer quota for each quota limit defined on the metric.',
    )
    descendantConsumerQuotaLimits: Optional[List[V1Beta1ConsumerQuotaLimit]] = Field(
        None,
...
class V1Beta1ImportProducerOverridesRequest(BaseModel):
    ...
    inlineSource: Optional[V1Beta1OverrideInlineSource] = Field(
        None, description='The import data is specified in the request message itself'
    )


class V1Beta1ListConsumerQuotaMetricsResponse(BaseModel):
    metrics: Optional[List[V1Beta1ConsumerQuotaMetric]] = Field(
